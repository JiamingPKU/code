            ...
            if run == 0:
                ...
                if maxbat < max(DIM[3] - ball_pos.y, ball_pos.y - DIM[2]):
                    if DIM[3] - ball_pos.y > ball_pos.y - DIM[2]: # 靠近下侧
                        run = (DIM[3] - ball_pos.y - maxbat) if abs(500000 - ball_pos.y) > abs(DIM[3] - ball_pos.y - maxbat) else (500000 - ball_pos.y)
                    else:
                        run = (DIM[2] - ball_pos.y + maxbat) if abs(500000 - ball_pos.y) > abs(DIM[2] - ball_pos.y + maxbat) else (500000 - ball_pos.y)
                else:
                    run = move
